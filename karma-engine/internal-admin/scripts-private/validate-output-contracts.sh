...
checks = [
    ("commercialization-gate", results / "commercialization-gate-latest.json", "karma.commercial.gate.v1"),
    ("proof-patrol-alert", results / "proof-patrol-alert-latest.json", "karma.proof.patrol.alert.v1"),
    ("agent-guardian-report", results / "agent-safety-guardian-latest.json", "karma.guardian.v1"),
    ("agent-guardian-alarm", results / "agent-safety-alarm-latest.json", "karma.guardian.alarm.v1"),
    ("agent-risk-register", results / "agent-risk-register.json", "karma.risk.register.v1"),
]
...
summary = {
    "schemaVersion": "karma.output.contract.validation.v1",
