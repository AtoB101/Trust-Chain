...
```json
{
  "schemaVersion": "karma.p0.paid-call.v1",
...
- `karma.p0.paid-call.v1`

### 3.1 Field definitions

| Field | Type | Required | Rule |
|---|---|---:|---|
| schemaVersion | string | yes | must equal `karma.p0.paid-call.v1` |
...
- `karma.p0.settlement.v1`

### 4.1 Field definitions

| Field | Type | Required | Rule |
|---|---|---:|---|
| schemaVersion | string | yes | must equal `karma.p0.settlement.v1` |
| generatedAt | string | yes | RFC3339 UTC |
| source | string | yes | producer id |
...
```json
{
  "schemaVersion": "karma.p0.settlement.v1",
...
- `karma.p0.evidence-bundle.v1`

### 5.1 Field definitions

| Field | Type | Required | Rule |
|---|---|---:|---|
| schemaVersion | string | yes | must equal `karma.p0.evidence-bundle.v1` |
| generatedAt | string | yes | RFC3339 UTC |
| source | string | yes | producer id |
...
```json
{
  "schemaVersion": "karma.p0.evidence-bundle.v1",
