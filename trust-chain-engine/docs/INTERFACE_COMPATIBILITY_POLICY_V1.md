...
This policy defines how `trust-chain-core` (public interfaces) and
`trust-chain-engine` (private implementations) evolve without version drift.

It applies to:

- SDK interfaces under `trust-chain-core/sdk/basic/*`
...
- `trust-chain-engine/docs/INTERFACE_COMPATIBILITY_POLICY_V1.md`
...
Any change in `trust-chain-core/sdk/basic/interfaces.ts` MUST include:
...
### Core CI (`trust-chain-core/.github/workflows/core-ci.yml`)
...
### Engine CI (`trust-chain-engine/.github/workflows/engine-ci.yml`)
